...
*           2014/08/26 1.28 fix problem on output of uncompress_() for tar file
...
*-----------------------------------------------------------------------------*/
extern unsigned int crc32_(const unsigned char *buff, int len)
{
    unsigned int crc=0;
    int i,j;
    
    trace(4,"crc32_: len=%d\n",len);
...
*-----------------------------------------------------------------------------*/
extern int uncompress_(const char *file, char *uncfile)
{
    int stat=0;
